...
## Corpus Check
- 231 files · ~661,321 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1402 nodes · 3912 edges · 114 communities (57 shown, 57 thin omitted)
...
Cohesion: 0.08
Nodes (39): customers, deliveryItems, deliverySerials, deliveryTasks, maintenanceLogs, payments, products, productSerials (+31 more)
...
Cohesion: 0.16
Nodes (17): client, db, notifications, logAction(), AuthRequest, cache, CacheEntry, clearApiCache() (+9 more)

### Community 4 - "authMiddleware.ts"
Cohesion: 0.10
Nodes (16): stockTransferItems, stockTransfers, router, findMasterByPassword(), getCachedPermission(), getPermissionCacheTtlMs(), isPrivilegedRole(), permissionCache (+8 more)

### Community 5 - "api.ts"
Cohesion: 0.15
Nodes (21): AiReportModal(), AiReportModalProps, Button(), buttonVariants, Card(), CardContent(), isPublicApi(), PUBLIC_API_ENDPOINTS (+13 more)

### Community 6 - "cash.ts"
Cohesion: 0.06
Nodes (45): accountMovements, cashMovements, cashRegisterBalances, cashRegisters, financialAccounts, payables, paymentMethodAccounts, personalCategories (+37 more)
...
Cohesion: 0.09
Nodes (41): Money(), MoneyProps, inputNumber(), PriceCurrencyInput(), PriceCurrencyInputProps, BaseCurrency, CurrencyDisplayPart, currencyLabel() (+33 more)

### Community 9 - "apiFetch"
Cohesion: 0.08
Nodes (42): ProtectedRoute(), CashRegisterBadge(), NotificationBell(), PurchaseItemRow(), useDebounce(), QuickGroupModal(), QuickSubgroupModal(), apiFetch() (+34 more)

### Community 10 - "store.ts"
Cohesion: 0.07
Nodes (25): customerAddresses, customerWishlist, productGroupsDraft, productImages, storeNewsletterSubscribers, CustomerAuthRequest, hits, requireCustomerAuth() (+17 more)

### Community 11 - "Products.tsx"
Cohesion: 0.21
Nodes (16): CompositionDonut(), ConfirmModal(), ConfirmModalProps, DataTable(), HardDeleteModal(), HardDeleteModalProps, Modal(), StockModal() (+8 more)
...
Cohesion: 0.07
Nodes (40): abandonedCarts, brandLogos, companySettings, currencies, deliveryPaymentOverrides, emailLogs, emailSettings, expenseCategories (+32 more)

### Community 15 - "ShopLayout.tsx"
Cohesion: 0.10
Nodes (25): formatCpf(), isFullName(), isValidCpf(), onlyDigits(), calcOrderTotal(), AccountAuth(), Country, AccountLayout() (+17 more)

### Community 16 - "statements.ts"
Cohesion: 0.07
Nodes (31): costConsumptions, costLayers, expenses, fxRates, purchaseOrderItems, purchaseOrders, saleItems, saleReturns (+23 more)

### Community 17 - "ShopProductCard.tsx"
Cohesion: 0.12
Nodes (27): storeApiFetch(), emptyForm, MyAddresses(), MyOrders(), statusClasses, MyProfile(), MyWishlist(), ResetPassword() (+19 more)
...
Cohesion: 0.15
Nodes (13): productLots, saleItemLots, addLotStock(), asExpiryDate(), consumeLotsFEFO(), restoreSaleLots(), router, generateAiContent() (+5 more)
...
Cohesion: 0.12
Nodes (13): qrcode, qrcode, formatBrl(), round2(), MarginPercentInput(), PixQr(), statusClasses, statusIcons (+5 more)
...
Cohesion: 0.11
Nodes (25): applyProductionSecurityHeaders(), buildCorsOptions(), ensureRuntimeSchema(), ensureTransferChecklistSchema(), resetMasterPasswordFromEnv(), runRuntimeDbTask(), startServer(), auditLogs (+17 more)
...
Cohesion: 0.11
Nodes (23): BarcodeDetectorLike, BarcodeScannerModal(), BarcodeScannerModalProps, loadHtml5Qrcode(), Window, formatDate(), useAdminTranslation, Finance() (+15 more)
...
Cohesion: 0.10
Nodes (22): Badge(), badgeVariants, AbcReport(), classStyle, firstOfMonth(), today(), brl(), cur() (+14 more)
...
Cohesion: 0.43
Nodes (6): ColorsPanel(), applyStoreColors(), contrastRatio(), DEFAULT_STORE_COLORS, relativeLuminance(), STORE_COLOR_TOKENS

### Community 42 - "Cash.tsx"
Cohesion: 0.15
Nodes (21): money(), onlyDigits(), ReceiptModal(), ReceiptModalProps, toWhatsAppNumber(), currencyCode(), currencySymbol(), moneyFieldLabel() (+13 more)
...
## Knowledge Gaps
- **365 isolated node(s):** `$schema`, `style`, `rsc`, `tsx`, `config` (+360 more)
...
- **Why does `apiFetch()` connect `apiFetch` to `App.tsx`, `StockTransfers.tsx`, `api.ts`, `StockMovementReport.tsx`, `badge.tsx`, `lib/i18n.ts`, `StoreHome.tsx`, `Cash.tsx`, `App`, `Products.tsx`, `Dashboard.tsx`, `useEditMode`, `charts.tsx`, `Toast.tsx`, `command.tsx`, `Layout.tsx`, `FinancialStatements.tsx`, `useAdminTranslation`?**
