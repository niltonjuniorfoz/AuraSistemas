...
### Community 18 - "useCustomerAuthStore"
Cohesion: 0.20
...
- **Why does `cn()` connect `cn` to `StockTransfers.tsx`, `App.tsx`, `PurchaseOcr.tsx`, `badge.tsx`, `SimpleDeliveries.tsx`, `ThemeCustomizer.tsx`, `command.tsx`, `Layout.tsx`, `FinancialStatements.tsx`, `lib/utils.ts`, `lib/i18n.ts`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `apiFetch()` connect `apiFetch` to `StockTransfers.tsx`, `App.tsx`, `StoreHome.tsx`, `PurchaseOcr.tsx`, `Products.tsx`, `Dashboard.tsx`, `StockMovementReport.tsx`, `badge.tsx`, `SimpleDeliveries.tsx`, `Finance.tsx`, `Pos.tsx`, `useEditMode`, `Toast.tsx`, `ReceiptModal.tsx`, `command.tsx`, `Layout.tsx`, `FinancialStatements.tsx`, `lib/i18n.ts`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `MONEY_EPSILON` connect `Pos.tsx` to `schema.ts`, `products.ts`, `store.ts`, `badge.tsx`, `lib/i18n.ts`?**
