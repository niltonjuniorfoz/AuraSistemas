...
async function createApp() {
  const [
    ...
    import("../src/server/customers"),
    import("../src/server/groups"),
    import("../src/server/shelves"),
    import("../src/server/auditRouter"),
    import("../src/server/sales"),
    import("../src/server/reports"),
    import("../src/server/health"),
    import("../src/server/archived"),
    import("../src/server/cash"),
    import("../src/server/separation"),
    import("../src/server/delivery"),
    import("../src/server/serials"),
    import("../src/server/settings"),
    import("../src/server/receipts"),
    import("../src/server/suppliers"),
    import("../src/server/purchases"),
    import("../src/server/expenses"),
    import("../src/server/dashboard"),
    import("../src/server/notifications"),
    import("../src/server/analytics"),
    import("../src/server/transfers"),
    import("../src/server/aiReports"),
    import("../src/server/master"),
    import("../src/server/lots"),
    import("../src/server/receivables"),
    import("../src/server/payables"),
    import("../src/server/finance"),
    import("../src/server/fx"),
    import("../src/server/costLayers"),
    import("../src/server/personal"),
    import("../src/server/store"),
    import("../src/server/customerAuth"),
    import("../src/server/intelligence"),
    import("../src/server/statements"),
    import("../src/server/maintenance"),
